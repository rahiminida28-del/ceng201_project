...
public class Wp6Demo {
    public static void main(String[] args){
        ...
        all[0] = new Submission("S-0101","project1.pdf", 2048, 79_500_000L,1,false);
        all[1] = new Submission("S-0109","project2.pdf", 3120, 79_506_000L,1,true);
        all[2] = new Submission("S-0102","project3.pdf", 1024, 79_502_000L,1,false);
        all[3] = new Submission("S-0103","project4.pdf", 4096, 79_507_000L,1,false);
        all[4] = new Submission("S-0104","project5.pdf", 2560, 79_503_000L,1,true);
        all[5] = new Submission("S-0105","project6.pdf", 1850, 79_504_000L,1,false);
        all[6] = new Submission("S-0106","project7.pdf", 4400,Submission.DEADLINE_MS,1,false);
        all[7] = new Submission("S-0107","project8.pdf", 3400, Submission.DEADLINE_MS+1000,1,false);
        all[8] = new Submission("S-0108","project9.pdf", 4500,Submission.DEADLINE_MS+2000,1,false);

        System.out.println("---Wp6  Demo Top3 largest files test---");
        ...
        System.out.println("Between two: " + ReportService.findFirstAfter(mergeSorted, 79_500_000L));


        //Deadline after all
        System.out.println("After all: " + ReportService.findFirstAfter(mergeSorted, 79_000_000L));
