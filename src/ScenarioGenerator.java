...
public class ScenarioGenerator {
    ...
    public static final long WINDOW_OPENS_MS = 79_200_000L;     //starting time 22:00:00.00
    public static final int BURST1_SIZE = 800;
    public static final int BURST2_SIZE = 850;
    public static final int BURST3_SIZE = 850;
    ...
    public Submission[] generateBurst1() {
        ...
        for (int i = 0; i < BURST1_SIZE; i++) {
            ...
            clockMs += 1 + rng.nextInt(1500); //hr yuklemede saati 1-1500ms ileri al
